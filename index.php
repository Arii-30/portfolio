...
<head>
  ...
  <title>ARI — CS Graduate & Developer</title>
  ...
  <style>
    ...
    *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    /* Contact Form (static, using Formspree) */
    .contact-form-card {
      background: var(--card);
      border: 1px solid var(--border);
      border-radius: 1.25rem;
...
<body>
      ...
      <div class="hero-grid">
        ...
        <div>
          ...
          <div class="hero-actions reveal reveal-delay-4">
            ...
            <a href="https://github.com/Arii-30" target="_blank" class="btn-ghost">
          ...
          <div class="hero-stats reveal reveal-delay-5">
            <div class="hero-stat">
              <span class="num">7<span>+</span></span>
  ...
  <section id="projects">
    <div class="container">
      ...
      <div class="projects-grid">
        ...
        <!-- Project 6: Advertisement Website -->
        <div class="project-card reveal reveal-delay-2">
          <div class="project-header">
            <div class="project-icon orange">📣</div>
          </div>
  ...
  <!-- =========================================
       CONTACT (static HTML + Formspree with Error Handling)
  ========================================= -->
  <section id="contact">
    <div class="container">
      <div class="section-header reveal">
          ...
          <div class="contact-details">
            <div class="contact-detail-item reveal reveal-delay-1">
              ...
              <div class="cdi-text">
                ...
                <div class="cdi-value">ariduhki@gmail.com</div>
              </div>
            </div>
            <div class="contact-detail-item reveal reveal-delay-2">
              ...
              <div class="cdi-text">
                ...
                <div class="cdi-value">0750-8649507</div>
              </div>
            </div>
            <div class="contact-detail-item reveal reveal-delay-3">
              ...
              <div class="cdi-text">
                ...
                <div class="cdi-value">Duhok, Kurdistan Region, Iraq</div>
              </div>
            </div>
          </div>

          <div class="social-row reveal reveal-delay-4">
            <a href="https://github.com/Arii-30" target="_blank" class="social-btn">
              <i class="fab fa-github"></i> GitHub
            </a>
            <a href="mailto:ariduhki@gmail.com" class="social-btn">
              <i class="fas fa-envelope"></i> Email
            </a>
          </div>
        </div>

        <!-- Right: form (with full error handling) -->
        <div class="contact-form-card reveal reveal-delay-2">
          <form id="contactForm">
            <!-- Feedback area for success/error messages -->
            <div id="formFeedback" style="display:none; padding:0.75rem 1rem; border-radius:0.75rem; margin-bottom:1.25rem; font-size:0.85rem;"></div>

            <div class="form-row">
              <div class="form-group">
                <label class="form-label" for="cf_name">Full Name</label>
                <input type="text" id="cf_name" name="name" class="form-control" placeholder="Your name" required>
              </div>
              <div class="form-group">
                <label class="form-label" for="cf_email">Email Address</label>
                <input type="email" id="cf_email" name="email" class="form-control" placeholder="your@email.com" required>
              </div>
            </div>

            <div class="form-group">
              <label class="form-label" for="cf_subject">Subject</label>
              <input type="text" id="cf_subject" name="subject" class="form-control" placeholder="What's this about?">
            </div>

            <div class="form-group">
              <label class="form-label" for="cf_message">Message</label>
              <textarea id="cf_message" name="message" class="form-control" rows="5" placeholder="Tell me about your project or opportunity..." required></textarea>
            </div>
          ...
          <p style="font-size:0.75rem; color:var(--text3); margin-top:1rem; text-align:center;">
            🔒 Your message is sent securely. If it fails, you'll see an error here to email me directly.
          </p>
        </div>
      </div>
    </div>
  ...
  <footer>
    <div class="container">
      <div class="footer-inner">
        ...
        <p class="footer-text">Built with passion in Duhok, Kurdistan &nbsp;•&nbsp; © <span id="year"></span> <span>Ari Khalaf Abdullah</span></p>
        <div style="display:flex;gap:0.5rem;">
          <a href="https://github.com/Arii-30" target="_blank" style="width:36px;height:36px;border:1px solid var(--border);border-radius:50%;display:flex;align-items:center;justify-content:center;color:var(--text2);font-size:0.9rem;transition:all 0.2s;" onmouseover="this.style.borderColor='var(--cyan)';this.style.color='var(--cyan)';" onmouseout="this.style.borderColor='var(--border)';this.style.color='var(--text2)';"><i class="fab fa-github"></i></a>
          <a href="mailto:ariduhki@gmail.com" style="width:36px;height:36px;border:1px solid var(--border);border-radius:50%;display:flex;align-items:center;justify-content:center;color:var(--text2);font-size:0.9rem;transition:all 0.2s;" onmouseover="this.style.borderColor='var(--cyan)';this.style.color='var(--cyan)';" onmouseout="this.style.borderColor='var(--border)';this.style.color='var(--text2)';"><i class="fas fa-envelope"></i></a>
        </div>
      </div>
    </div>
  </footer>
  ...
  <script>
    ...
    // ---- TYPING ANIMATION (Updated for Graduate) ----
    const roles = [
      'CS Graduate',
      'PHP Developer',
      'Full-Stack Dev',
    ...
    form.addEventListener('submit', async (e) => {
      ...
      const subject = document.getElementById('cf_subject').value.trim() || 'Portfolio Contact';
      const message = document.getElementById('cf_message').value.trim();

      // Client-side validation
      if (!name || !email || !message) {
        feedback.style.display = 'block';
        feedback.style.backgroundColor = 'var(--orange-dim)';
      ...
      try {
        ...
        if (response.ok) {
          feedback.style.display = 'block';
          feedback.style.backgroundColor = 'var(--cyan-dim)';
          feedback.style.color = 'var(--cyan)';
          feedback.textContent = '✅ Your message was sent successfully! I\'ll get back to you soon.';
          form.reset();
        } else {
        ...
        feedback.style.backgroundColor = 'var(--orange-dim)';
        feedback.style.color = 'var(--orange)';
        feedback.textContent = '❌ Oops! Could not send the message. Please email me directly at: ariduhki@gmail.com';
